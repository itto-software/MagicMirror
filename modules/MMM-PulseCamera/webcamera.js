(function (window) {
    ...
    var HeartRateCam = {
        ...
        drawLoop: function () {
            ...
            // 顔のトラッキングを実行
            var isSuccess = this.tracker.track(this.videoMain);
            if (isSuccess) {
            ...
            // グラフの追加
            var canvas1 = canvasMain;
            // this.datas.push(heartRate);
            this.model.pushWithLimit(this.datas, this.model.nHistoryMax, heartRate);

            // var datas = this.model.hSignal[0];
            var line_opts = {
                color: 'green',
                width: 2
            };
        ...
        init: function () {
            ...
            this.pm.desiredTimeInterval = 60;    // [ms] 60 fps(約17 msごと)で調べると、50 msと51 msとの比較になるので20 fpsが出ない。
